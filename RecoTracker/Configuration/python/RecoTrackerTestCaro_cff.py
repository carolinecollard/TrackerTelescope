...
#CARO from RecoTracker.SpecialSeedGenerators.CombinatorialSeedGeneratorForCosmicsP5_cff_copy import *
#CARO from RecoTracker.SpecialSeedGenerators.CombinatorialSeedGeneratorForTestCaro_cff import *
...
#CARO    cms.InputTag('combinatorialcosmicseedfinderP5'),
    cms.InputTag('combinatorialseedfinderTelescope'),
#CARO5    cms.InputTag('simpleCosmicBONSeeds'),
)
#backward compatibility 2.2/3.1
#CARO combinedP5SeedsForCTF.PairCollection = cms.InputTag('combinatorialcosmicseedfinderP5')
combinedP5SeedsForCTF.PairCollection = cms.InputTag('combinatorialseedfinderTelescope')
combinedP5SeedsForCTF.TripletCollection = cms.InputTag('combinatorialseedfinderTelescope')
#CARO5 combinedP5SeedsForCTF.TripletCollection = cms.InputTag('simpleCosmicBONSeeds')

from RecoTracker.CkfPattern.CkfTrackCandidatesP5_cff import *
ckfTrackCandidatesP5.src = cms.InputTag('combinatorialseedfinderTelescope')
#CARO6 ckfTrackCandidatesP5.src = cms.InputTag('combinedP5SeedsForCTF')
#backward compatibility 2.2/3.1
...
#CARO ctftracksP5 = cms.Sequence(combinatorialcosmicseedinglayersP5+combinatorialcosmicseedfinderP5*
ctftracksP5 = cms.Sequence(combinatorialseedinglayersTelescope+combinatorialseedfinderTelescope*
#CARO5                           simpleCosmicBONSeedingLayers*simpleCosmicBONSeeds*combinedP5SeedsForCTF*
#CARO6                           combinedP5SeedsForCTF*
